...
func Test_client(t *testing.T) {
	if client, err := NewConnect(false, "db.tlnet.top:7001", "mycli=123"); err == nil {
		//create table
		client.CreateTable("usertest", map[string]COLUMNTYPE{"name": STRING, "age": STRING, "type": STRING}, []string{"name", "type"})
		//insert data
